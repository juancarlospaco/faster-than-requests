...
RUN nim c -d:release -d:ssl --app:lib --threads:on --passL:"-s" --gc:markAndSweep --passC:"-march=native" --passC:"-flto" --passC:"-ffast-math" --out:/tmp/faster_than_requests.so /tmp/faster_than_requests.nim
