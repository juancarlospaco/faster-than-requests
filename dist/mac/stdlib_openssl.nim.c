...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15965614_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15975622_;
static void* TM__SLGpYVEqpFQ7VaPsJH6HIA_47;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965701_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_15965724_;
tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_15966026_;
tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_15966020_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_15965619_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15965616_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_15965697_;
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_15975443_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965711_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965728_;
tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_15965719_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965731_;
tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_15965714_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15965637_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_15951248_;
tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_15965660_;
...
tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_15975414_;
tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_15965648_;
tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_15965669_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15965673_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965678_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15975572_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_15975578_;
tyProc__h4YRAkwlfyBfCYwRiY5JqA Dl_15975614_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_15975593_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_15975596_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15975609_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15975580_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15975583_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15975588_;
tyProc__v9chVxaoEEAWoxVjnpYxttA Dl_15965704_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15975599_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_15975443_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
	void* T1_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	NI result;
	result = (NI)0;
	result = Dl_15975414_(ctx, ((int) 33), mode, NIM_NIL);
	return result;
}
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_6 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_38)))
	...
	Dl_15965614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_load_BIO_strings");
	Dl_15975622_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_clear_error");
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_47 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_79)))
	...
	Dl_15965701_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_shutdown");
	Dl_15965724_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_get_error");
	Dl_15966026_ = (tyProc__wCuLyuC5VitcgJKGCqJQRw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_peek_last_error");
	Dl_15966020_ = (tyProc__5zMKCPIiPHTYY9cjyzsHlmQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_error_string");
	Dl_15965619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_free");
	Dl_15965616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_new");
	Dl_15965697_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_set_fd");
	Dl_15975443_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_ctrl");
	Dl_15965711_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_connect");
	Dl_15965728_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_accept");
	Dl_15965719_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_write");
	Dl_15965731_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_pending");
	Dl_15965714_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_read");
	Dl_15965637_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_new");
	Dl_15951248_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "TLSv1_method");
	Dl_15965660_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_set_cipher_list");
	Dl_15975414_ = (tyProc__JfY9aCDiBh9bgOEieo8Vltxg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_ctrl");
	Dl_15965648_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_set_verify");
	Dl_15965669_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_use_certificate_chain_file");
	Dl_15965673_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_use_PrivateKey_file");
	Dl_15965678_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_CTX_check_private_key");
	Dl_15975572_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "BIO_new");
	Dl_15975578_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "BIO_s_mem");
	Dl_15975614_ = (tyProc__h4YRAkwlfyBfCYwRiY5JqA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_set_bio");
	Dl_15975593_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_set_connect_state");
	Dl_15975596_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_set_accept_state");
	Dl_15975609_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_write");
	Dl_15975580_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "BIO_ctrl_pending");
	Dl_15975583_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "BIO_read");
	Dl_15975588_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "BIO_write");
	Dl_15965704_ = (tyProc__v9chVxaoEEAWoxVjnpYxttA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_set_shutdown");
	Dl_15975599_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "SSL_read");
}
