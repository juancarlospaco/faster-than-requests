...
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15965614_;
...
extern tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_15966026_;
extern tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_15966020_;
...
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_15965697_;
extern NIM_THREADVAR Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern NIM_THREADVAR Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern NIM_THREADVAR Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965711_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965728_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_15965719_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965731_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_15965714_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15965637_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_15951248_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_15965660_;
extern tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_15975414_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_15965648_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_15965669_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15965673_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15965678_;
...
{nimErr_ = nimErrorFlag();
	{
		if (!(*socket).isSsl) goto LA3_;
		{
			...
			ret = Dl_15965724_((*socket).sslHandle, ((int) (err)));
			switch (ret) {
			case ((NI) 6):
			{
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_16));
					...
					LA38_: ;
					{
						...
						NimStringDesc* T42_;
						T41_ = (NCSTRING)0;
						T41_ = Dl_15966020_(sslErr, NIM_NIL);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T4_) goto LA6_;
		{
			...
			LA30_: ;
			{
				...
				NI32 T38_;
				T35_ = (int)0;
				T35_ = pthread_sigmask(SIG_BLOCK, (&watchSetX60gensym102_), (&oldSetX60gensym102_));
			...
			LA43_: ;
			{
				...
				sslError = Dl_15965724_((*socket).sslHandle, res);
				{
					NIM_BOOL T50_;
					T50_ = (NIM_BOOL)0;
			...
			}
			{
				oldNimErrFin40_ = *nimErr_; *nimErr_ = NIM_FALSE;
				{
					if (!!(alreadyBlockedX60gensym102_)) goto LA64_;
					{
						...
						NI32 T71_;
						T68_ = (int)0;
						T68_ = pthread_sigmask(SIG_UNBLOCK, (&watchSetX60gensym102_), (&oldSetX60gensym102_));
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_15965697_((*socket).sslHandle, (*socket).fd);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		Dl_15975622_();
		ret = Dl_15965711_((*socket).sslHandle);
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		Dl_15975622_();
		ret_2 = Dl_15965728_((*socket).sslHandle);
...
{	result = (NI)0;
	{
		...
		Dl_15975622_();
		T5_ = (int)0;
		T5_ = Dl_15965719_((*socket).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_35));
		...
		LA21_: ;
		{
			...
			LA32_: ;
			sslPending = Dl_15965731_((*socket).sslHandle);
			{
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		Dl_15975622_();
		T5_ = (int)0;
		T5_ = Dl_15965714_((*socket).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		if (!T3_) goto LA7_;
		T9_ = (long)0;
		T9_ = Dl_15975414_(ctx, ((int) 94), ((long) (onoff)), NIM_NIL);
		result = ((int) (T9_));
	}
	goto LA1_;
	LA7_: ;
...
appendString(T18_, keyFile);
	...
	LA15_: ;
	{
		...
		ret = Dl_15965669_(ctx, nimToCStringConv(certFile));
		{
	...
	LA21_: ;
	{
		if (!!(((keyFile ? keyFile->Sup.len : 0) == 0))) goto LA29_;
		{
			int T33_;
			T33_ = (int)0;
			T33_ = Dl_15965673_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_15965660_(newCTX, nimToCStringConv(cipherList));
	...
	LA26_: ;
	Dl_15965648_(newCTX, ((NI) 0), NIM_NIL);
	{
...
static TNimNode* TM__XqsrSBxhOTPgLQ9cX4MmV4A_44_2[2];
NI TM__XqsrSBxhOTPgLQ9cX4MmV4A_46;
static char* NIM_CONST TM__XqsrSBxhOTPgLQ9cX4MmV4A_45[2] = {
"Peek", 
"SafeDisconn"};
...
for (TM__XqsrSBxhOTPgLQ9cX4MmV4A_46 = 0; TM__XqsrSBxhOTPgLQ9cX4MmV4A_46 < 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_46++) {
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46+32].kind = 1;
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46+32].offset = TM__XqsrSBxhOTPgLQ9cX4MmV4A_46;
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46+32].name = TM__XqsrSBxhOTPgLQ9cX4MmV4A_45[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46];
TM__XqsrSBxhOTPgLQ9cX4MmV4A_44_2[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_46+32];
}
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].len = 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].kind = 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].sons = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_44_2[0];
