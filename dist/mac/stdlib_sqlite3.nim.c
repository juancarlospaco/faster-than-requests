...
STRING_LITERAL(TM__ZpuQ9cIusnUOv1iEoFq9arZw_4, "libsqlite3.dylib", 16);
STRING_LITERAL(TM__ZpuQ9cIusnUOv1iEoFq9arZw_6, "libsqlite3.0.dylib", 18);
STRING_LITERAL(TM__ZpuQ9cIusnUOv1iEoFq9arZw_7, "libsqlite3(|.0).dylib", 21);

/* section: NIM_merge_VARS */
static void* TM__ZpuQ9cIusnUOv1iEoFq9arZw_2;
tyProc__MGvm2GDOLe9cOGVrF2xiL8g Dl_24436915_;
tyProc__9c803Jlmvw39cDHXPnE9c9acPA Dl_24436928_;
tyProc__M35TeFGPs7TPKADYDaEq4Q Dl_24436943_;
tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_24437059_;
tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_24437101_;
tyProc__gjdebP9bh9a6kXA5fmIpsLzQ Dl_24436809_;
...
||(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2 = nimLoadLibrary(((NimStringDesc*) &TM__ZpuQ9cIusnUOv1iEoFq9arZw_6)))
	...
	Dl_24436915_ = (tyProc__MGvm2GDOLe9cOGVrF2xiL8g) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_open");
	Dl_24436928_ = (tyProc__9c803Jlmvw39cDHXPnE9c9acPA) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_errmsg");
	Dl_24436943_ = (tyProc__M35TeFGPs7TPKADYDaEq4Q) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_prepare_v2");
	Dl_24437059_ = (tyProc__1jkYBsuhXdCj7QieWqeYyQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_step");
	Dl_24437101_ = (tyProc__1jkYBsuhXdCj7QieWqeYyQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_finalize");
	Dl_24436809_ = (tyProc__gjdebP9bh9a6kXA5fmIpsLzQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_close");
}
