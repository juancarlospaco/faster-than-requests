...
STRING_LITERAL(TM__9b9bytt1stv9cZ8uqII7HFgew_33, "isTitleCase", 11);
...
appendString((*result), ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_28));
	...
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg) 1):
	{
		...
		T52_ = (NimStringDesc*)0;
		{
			...
			T52_ = copyString(((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_22));
		}
		goto LA53_;
		LA55_: ;
		{
			T52_ = copyString(((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_23));
		}
		LA53_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q*, percent___UypyWQYgs0HwDiqUF1vrHQ)(tyObject_HttpHeaderscolonObjectType___GM611pWlOrQ7hvMPcuAACA o) {
	...
	T2_ = percent___cUNUWspDCIapW3x6fFYyZQ_2(o.isTitleCase);
	X5BX5Deq___WmQhibcOp3ZlzI9bgifjalAjson(result, ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_33), T2_);
	return result;
}
