...
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15485614_;
extern NI32 globalsSlot__ciXDZu9c27pHpCRMoz4RIgw;
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15495632_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15485696_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_15485719_;
extern tyProc__HBcM2Mt9bfW9bP8CkO25r0mA Dl_15486026_;
extern tyProc__ILGNrKdZ6rU9bHuzDylmHhA Dl_15486020_;
extern tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_15485619_;
extern NI osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w;
extern tyProc__IV3cwg4tBg3JP8ITSKt7oQ Dl_12983456_;
extern tyProc__T129bsPZ4FvuSF4rGFSBKkg Dl_12983281_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15485616_;
extern tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_15485692_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15485706_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15485723_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_15485714_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_12983345_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15485726_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_15485709_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_12983320_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15485632_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_15470665_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_15485655_;
extern tyProc__J5jVzoevP749cPcyUg9cwPEA Dl_15495414_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_15485643_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_15485664_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15485668_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15485673_;
...
{nimErr_ = nimErrorFlag();
	{
		if (!(*socket_0).isSsl) goto LA3_;
		{
			...
			ret = Dl_15485719_((*socket_0).sslHandle, ((int) (err)));
			switch (ret) {
			case ((NI) 6):
			{
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_14));
					...
					LA38_: ;
					{
						...
						NimStringDesc* T42_;
						T41_ = (NCSTRING)0;
						T41_ = Dl_15486020_(sslErr, NIM_NIL);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T4_) goto LA6_;
		{
			...
			if (!T10_) goto LA13_;
			Dl_15495632_();
			res = Dl_15485696_((*socket_0).sslHandle);
			{
			...
			LA17_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				sslError = Dl_15485719_((*socket_0).sslHandle, res);
				{
					NIM_BOOL T24_;
					T24_ = (NIM_BOOL)0;
	...
	}
	{
		oldNimErrFin1_ = *nimErr_; *nimErr_ = NIM_FALSE;
		{
			...
			LA39_: ;
			if (!T38_) goto LA40_;
			Dl_15485619_((*socket_0).sslHandle);
		...
		while (1) {
			if (!!((it == NIM_NIL))) goto LA5;
			{
				...
				LA15_: ;
				{
					int T40_;
					T40_ = (int)0;
					T40_ = Dl_12983281_(lastFd, (*it).ai_addr, ((unsigned int) ((*it).ai_addrlen)));
...
{nimErr_ = nimErrorFlag();
	...
	(*socket_0).sslHandle = Dl_15485616_((*(*socket_0).sslContext).context);
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_15485692_((*socket_0).sslHandle, (*socket_0).fd);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		Dl_15495632_();
		ret = Dl_15485706_((*socket_0).sslHandle);
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		Dl_15495632_();
		ret_2 = Dl_15485723_((*socket_0).sslHandle);
...
{	result = (NI)0;
	{
		...
		Dl_15495632_();
		T5_ = (int)0;
		T5_ = Dl_15485714_((*socket_0).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (int)0;
	T6_ = Dl_12983345_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
	result = ((NI) (T6_));
	}BeforeRet_: ;
	return result;
}
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_32));
		...
		LA21_: ;
		{
			...
			LA32_: ;
			sslPending = Dl_15485726_((*socket_0).sslHandle);
			{
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		Dl_15495632_();
		T5_ = (int)0;
		T5_ = Dl_15485709_((*socket_0).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (int)0;
	T6_ = Dl_12983320_((*socket_0).fd, buffer, size, flags);
	result = ((NI) (T6_));
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	LA7_: ;
	{
		...
		LA40_: ;
		{
			int T54_;
			T54_ = (int)0;
			T54_ = Dl_12983320_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
			result = ((NI) (T54_));
		}
		LA38_: ;
		{
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		LA18_: ;
		T25_ = (int)0;
		T25_ = Dl_12983320_((*socket_0).fd, ((void*) (c)), ((int) 1), ((int) 2));
		result = ((NI) (T25_));
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		LA5_: ;
		if (!T3_) goto LA7_;
		result = Dl_15495414_(ctx, ((int) 94), onoff, NIM_NIL);
	}
	goto LA1_;
	LA7_: ;
	{
...
appendString(T18_, keyFile);
	...
	LA15_: ;
	{
		...
		ret = Dl_15485664_(ctx, nimToCStringConv(certFile));
		{
	...
	LA21_: ;
	{
		if (!!(((keyFile ? keyFile->Sup.len : 0) == 0))) goto LA29_;
		{
			int T33_;
			T33_ = (int)0;
			T33_ = Dl_15485668_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_15485655_(newCTX, nimToCStringConv(cipherList));
	...
	LA26_: ;
	Dl_15485643_(newCTX, ((NI) 0), NIM_NIL);
	{
