...
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15780614_;
...
extern tyProc__HBcM2Mt9bfW9bP8CkO25r0mA Dl_15781026_;
extern tyProc__ILGNrKdZ6rU9bHuzDylmHhA Dl_15781020_;
...
extern tyProc__T129bsPZ4FvuSF4rGFSBKkg Dl_13013304_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15780616_;
extern tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_15780697_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15780711_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15780728_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_15780719_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_13013368_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15780731_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_15780714_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_13013343_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_15780637_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_15765661_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_15780660_;
extern tyProc__J5jVzoevP749cPcyUg9cwPEA Dl_15790414_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_15780648_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_15780669_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_15780673_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_15780678_;
...
{nimErr_ = nimErrorFlag();
	{
		if (!(*socket_0).isSsl) goto LA3_;
		{
			...
			ret = Dl_15780724_((*socket_0).sslHandle, ((int) (err)));
			switch (ret) {
			case ((NI) 6):
			{
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_14));
					...
					LA38_: ;
					{
						...
						NimStringDesc* T42_;
						T41_ = (NCSTRING)0;
						T41_ = Dl_15781020_(sslErr, NIM_NIL);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T4_) goto LA6_;
		{
			...
			LA17_: ;
			{
				...
				sslError = Dl_15780724_((*socket_0).sslHandle, res);
				{
					NIM_BOOL T24_;
					T24_ = (NIM_BOOL)0;
		...
		while (1) {
			if (!!((it == NIM_NIL))) goto LA5;
			{
				...
				LA15_: ;
				{
					int T40_;
					T40_ = (int)0;
					T40_ = Dl_13013304_(lastFd, (*it).ai_addr, ((unsigned int) ((*it).ai_addrlen)));
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_15780697_((*socket_0).sslHandle, (*socket_0).fd);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		Dl_15790622_();
		ret = Dl_15780711_((*socket_0).sslHandle);
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		Dl_15790622_();
		ret_2 = Dl_15780728_((*socket_0).sslHandle);
...
{	result = (NI)0;
	{
		...
		Dl_15790622_();
		T5_ = (int)0;
		T5_ = Dl_15780719_((*socket_0).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (int)0;
	T6_ = Dl_13013368_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
	result = ((NI) (T6_));
	}BeforeRet_: ;
	return result;
}
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_32));
		...
		LA21_: ;
		{
			...
			LA32_: ;
			sslPending = Dl_15780731_((*socket_0).sslHandle);
			{
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		Dl_15790622_();
		T5_ = (int)0;
		T5_ = Dl_15780714_((*socket_0).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (int)0;
	T6_ = Dl_13013343_((*socket_0).fd, buffer, size, flags);
	result = ((NI) (T6_));
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
{	result = (NI)0;
	...
	LA7_: ;
	{
		...
		LA40_: ;
		{
			int T54_;
			T54_ = (int)0;
			T54_ = Dl_13013343_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
			result = ((NI) (T54_));
		}
		LA38_: ;
		{
...
{	result = (NI)0;
	...
	LA3_: ;
	{
		...
		LA18_: ;
		T25_ = (int)0;
		T25_ = Dl_13013343_((*socket_0).fd, ((void*) (c)), ((int) 1), ((int) 2));
		result = ((NI) (T25_));
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		LA5_: ;
		if (!T3_) goto LA7_;
		result = Dl_15790414_(ctx, ((int) 94), onoff, NIM_NIL);
	}
	goto LA1_;
	LA7_: ;
	{
...
appendString(T18_, keyFile);
	...
	LA15_: ;
	{
		...
		ret = Dl_15780669_(ctx, nimToCStringConv(certFile));
		{
	...
	LA21_: ;
	{
		if (!!(((keyFile ? keyFile->Sup.len : 0) == 0))) goto LA29_;
		{
			int T33_;
			T33_ = (int)0;
			T33_ = Dl_15780673_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_15780660_(newCTX, nimToCStringConv(cipherList));
	...
	LA26_: ;
	Dl_15780648_(newCTX, ((NI) 0), NIM_NIL);
	{
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43+32].kind = 1;
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43+32].offset = TM__XqsrSBxhOTPgLQ9cX4MmV4A_43;
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43+32].name = TM__XqsrSBxhOTPgLQ9cX4MmV4A_42[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43];
TM__XqsrSBxhOTPgLQ9cX4MmV4A_41_2[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[TM__XqsrSBxhOTPgLQ9cX4MmV4A_43+32];
}
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].len = 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].kind = 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[34].sons = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_41_2[0];
