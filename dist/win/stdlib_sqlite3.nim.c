...
tyProc__MGvm2GDOLe9cOGVrF2xiL8g Dl_23977115_;
tyProc__9c803Jlmvw39cDHXPnE9c9acPA Dl_23977128_;
tyProc__M35TeFGPs7TPKADYDaEq4Q Dl_23977143_;
tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_23977259_;
tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_23977301_;
tyProc__gjdebP9bh9a6kXA5fmIpsLzQ Dl_23977009_;
...
if (!((TM__ZpuQ9cIusnUOv1iEoFq9arZw_2 = nimLoadLibrary(((NimStringDesc*) &TM__ZpuQ9cIusnUOv1iEoFq9arZw_4)))
	...
	Dl_23977115_ = (tyProc__MGvm2GDOLe9cOGVrF2xiL8g) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_open");
	Dl_23977128_ = (tyProc__9c803Jlmvw39cDHXPnE9c9acPA) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_errmsg");
	Dl_23977143_ = (tyProc__M35TeFGPs7TPKADYDaEq4Q) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_prepare_v2");
	Dl_23977259_ = (tyProc__1jkYBsuhXdCj7QieWqeYyQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_step");
	Dl_23977301_ = (tyProc__1jkYBsuhXdCj7QieWqeYyQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_finalize");
	Dl_23977009_ = (tyProc__gjdebP9bh9a6kXA5fmIpsLzQ) nimGetProcAddr(TM__ZpuQ9cIusnUOv1iEoFq9arZw_2, "sqlite3_close");
}
