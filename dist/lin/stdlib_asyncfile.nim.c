...
typedef struct tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA;
...
struct tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA {
  RootObj Sup;
NI colonstate_;
...
N_LIB_PRIVATE N_CLOSURE(NIM_BOOL, cb__ZFGVPOYTo7HMbePjkBbc8A)(int fd, void* ClE_0);
...
static N_NIMCALL(void, Marker_tyRef__sSFXSLqKZKDYE4YWvHjyWg)(void* p, NI op) {
	tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA* a;
	a = (tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA*)p;
...
N_LIB_PRIVATE N_CLOSURE(NIM_BOOL, cb__ZFGVPOYTo7HMbePjkBbc8A)(int fd, void* ClE_0) {
	NIM_BOOL result;
	tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA* colonenvP_;
	NI res;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	colonenvP_ = (tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA*) ClE_0;
	result = NIM_TRUE;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_FuturecolonObjectType___DytvWkqCHojL9aGfYktbFPw*, read__Pxh9c3co7yoSxJ9cj2BoeYBQ)(tyObject_AsyncFilecolonObjectType___FOwUW0XSSxm8sZ1ubj9b52w* f, NI size) {
	...
	tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA* colonenv_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = (tyObject_FuturecolonObjectType___DytvWkqCHojL9aGfYktbFPw*)0;
	colonenv_ = (tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA*)0;
	colonenv_ = (tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA*) newObj((&NTI__sSFXSLqKZKDYE4YWvHjyWg_), sizeof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA));
	...
	{
		tyProc__9cnjNsE9aOh8FkRG9ccBKTpWg T3_;
		NIM_BOOL T4_;
		tyProc__9cnjNsE9aOh8FkRG9ccBKTpWg T7_;
		nimZeroMem((void*)(&T3_), sizeof(tyProc__9cnjNsE9aOh8FkRG9ccBKTpWg));
		T3_.ClP_0 = cb__ZFGVPOYTo7HMbePjkBbc8A; T3_.ClE_0 = colonenv_;
		T4_ = (NIM_BOOL)0;
		T4_ = T3_.ClE_0? T3_.ClP_0((*(*colonenv_).f4).fd, T3_.ClE_0):((TM__3Pfl7Yz4kHPpbtUoHRPC9aw_5)(T3_.ClP_0))((*(*colonenv_).f4).fd);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T4_)) goto LA5_;
		nimZeroMem((void*)(&T7_), sizeof(tyProc__9cnjNsE9aOh8FkRG9ccBKTpWg));
		T7_.ClP_0 = cb__ZFGVPOYTo7HMbePjkBbc8A; T7_.ClE_0 = colonenv_;
		addRead__d4cUMxhuTkjAmuokqTipNA_2((*(*colonenv_).f4).fd, T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA5_: ;
...
NTI__ovVFCD1DtyiEVL86gOLWjA_.size = sizeof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA);
...
TM__3Pfl7Yz4kHPpbtUoHRPC9aw_0[4].offset = offsetof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA, colonstate_);
...
TM__3Pfl7Yz4kHPpbtUoHRPC9aw_0[5].offset = offsetof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA, readBuffer1);
...
TM__3Pfl7Yz4kHPpbtUoHRPC9aw_0[6].offset = offsetof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA, size2);
...
TM__3Pfl7Yz4kHPpbtUoHRPC9aw_0[7].offset = offsetof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA, retFuture3);
...
TM__3Pfl7Yz4kHPpbtUoHRPC9aw_0[8].offset = offsetof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA, f4);
...
NTI__sSFXSLqKZKDYE4YWvHjyWg_.size = sizeof(tyObject_Env_asyncfiledotnim___ovVFCD1DtyiEVL86gOLWjA*);
