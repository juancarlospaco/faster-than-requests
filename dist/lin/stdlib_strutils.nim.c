...
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_6, "y", 1);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_7, "yes", 3);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_8, "true", 4);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_9, "1", 1);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_10, "on", 2);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_11, "n", 1);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_12, "no", 2);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_13, "false", 5);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_14, "0", 1);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_15, "off", 3);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_16, "cannot interpret as a bool: ", 28);
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_17, "invalid float: ", 15);
extern TNimType NTI__sM4lkSb7zS6F7OVMvW9cffQ_;
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_18, "invalid hex integer: ", 21);
static NIM_CONST tySet_tyChar__nmiMWKVIe46vacnhAFrQvw TM__JGc9b9bh2D3nTdUR7TGyq8aA_19 = {
...
break;
	case 1: 
if (eqStrings(T1_, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_11))) goto LA3_;
break;
	case 5: 
...
break;
	case 8: 
if (eqStrings(T1_, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_6))) goto LA2_;
...
appendString(T10_, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_16));
appendString(T10_, s);
		(*T9_).Sup.Sup.message = T10_;
		(*T9_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T9_, "ValueError", "parseBool", "strutils.nim", 1279);
		goto BeforeRet_;
	}
	LA5_: ;
	}BeforeRet_: ;
...
appendString(T8_, s);
		(*T7_).Sup.Sup.message = T8_;
		(*T7_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T7_, "ValueError", "parseBiggestInt", "strutils.nim", 1139);
		goto BeforeRet_;
	}
	LA5_: ;
	}BeforeRet_: ;
...
appendString(T8_, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_17));
appendString(T8_, s);
		(*T7_).Sup.Sup.message = T8_;
		(*T7_).Sup.Sup.parent = NIM_NIL;
...
appendString(T8_, s);
		(*T7_).Sup.Sup.message = T8_;
		(*T7_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T7_, "ValueError", "parseHexInt", "strutils.nim", 1216);
		goto BeforeRet_;
	}
	LA5_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, multiReplace__bE9ctzdR0d2caO0lr9a9b8Jng)(NimStringDesc* s, tyTuple__UV3llMMYFckfui8YMBuUZA* replacements, NI replacementsLen_0) {
	...
	nimCopyMem((void*)fastChk, (NIM_CONST void*)TM__JGc9b9bh2D3nTdUR7TGyq8aA_19, 32);
	{
		NimStringDesc** sub;
		NimStringDesc** by;
		NI i_2;
