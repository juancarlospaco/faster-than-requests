...
tyProc__sYEjOwC8kj9bf3dL1zf0Hrw Dl_15675015_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_15710677_;
...
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_15710488_;
...
tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_15710459_;
...
N_LIB_PRIVATE N_NIMCALL(void, CRYPTO_malloc_init__G2BDIxFj2W9ajANxAoi8oZA)(void) {
	Dl_15675015_(((void*) (allocWrapper__RKtAA5JYxWxZj79aCAifPvA)), ((void*) (reallocWrapper__9cfMO5SIG9bC9adqbrJrcB70Q)), ((void*) (deallocWrapper__uOonBuLtXfZwTuGZR20a6Q)));
}
static N_INLINE(NCSTRING, nimToCStringConv)(NimStringDesc* s) {
	NCSTRING result;
	result = (NCSTRING)0;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_15710488_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
	void* T1_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	NI result;
	result = (NI)0;
	result = Dl_15710459_(ctx, ((int) 33), mode, NIM_NIL);
	return result;
}
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_2 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_34)))
	...
	Dl_15675015_ = (tyProc__sYEjOwC8kj9bf3dL1zf0Hrw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_2, "CRYPTO_set_mem_functions");
	Dl_15665614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_2, "ERR_load_BIO_strings");
	Dl_15710677_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_2, "ERR_clear_error");
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_49 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_81)))
	...
	Dl_15665696_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_shutdown");
	Dl_15665719_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_get_error");
	Dl_15666026_ = (tyProc__wCuLyuC5VitcgJKGCqJQRw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_2, "ERR_peek_last_error");
	Dl_15666020_ = (tyProc__5zMKCPIiPHTYY9cjyzsHlmQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_2, "ERR_error_string");
	Dl_15665619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_free");
	Dl_15665616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_new");
	Dl_15665692_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_set_fd");
	Dl_15710488_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_ctrl");
	Dl_15665706_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_connect");
	Dl_15665723_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_accept");
	Dl_15665714_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_write");
	Dl_15665726_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_pending");
	Dl_15665709_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_read");
	Dl_15665632_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_new");
	Dl_15651252_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "TLSv1_method");
	Dl_15665655_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_set_cipher_list");
	Dl_15710459_ = (tyProc__JfY9aCDiBh9bgOEieo8Vltxg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_ctrl");
	Dl_15665643_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_set_verify");
	Dl_15665664_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_use_certificate_chain_file");
	Dl_15665668_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_use_PrivateKey_file");
	Dl_15665673_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_CTX_check_private_key");
}
