...
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_11, "ioselectors_epoll.nim(395, 15) `\012not (pkey.ident == InvalidIden"
"t)` ", 67);
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_12, "Maximum number of descriptors is exhausted!", 43);
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_13, "ioselectors_epoll.nim(195, 11) `\012not (pkey.ident == InvalidIden"
"t)` ", 67);
...
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_15, "ioselectors_epoll.nim(167, 11) `\012not (pkey.ident == InvalidIden"
"t)` ", 67);
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_16, "ioselectors_epoll.nim(169, 11) `pkey.events * maskEvents == {}`"
" ", 64);
STRING_LITERAL(TM__ln5vuDpFyDrAqQbYD2g52Q_17, "ioselectors_epoll.nim(150, 11) `s.fds[fdi].ident == InvalidIden"
"t` ", 66);
	...
	LA3_: ;
	{
		...
		numFDX60gensym84_ = (*s).numFD;
		{
			while (1) {
				...
				stareq___ogcC1Md4c289bEhAZWpmZUwsystem((&numFDX60gensym84_), ((NI) 2));
			} LA10: ;
		}
		(*s).fds = (tySequence__5L9b5Ztm9adPEys1vE9cEPQJA*) setLengthSeqV2(&((*s).fds)->Sup, (&NTI__5L9b5Ztm9adPEys1vE9cEPQJA_), ((NI) (numFDX60gensym84_)));
		{
			NI iX60gensym84_;
			NI i;
			iX60gensym84_ = (NI)0;
...
appendString(T18_, T20_);
	...
	(*pkey).ident = ((NI) -1);
	(*pkey).events = 0;
	genericSeqAssign((&(*pkey).data.readList), emptyX60gensym91_.readList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	genericSeqAssign((&(*pkey).data.writeList), emptyX60gensym91_.writeList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	}BeforeRet_: ;
}
	...
	LA3_: ;
	{
		...
		numFDX60gensym41_ = (*s).numFD;
		{
			while (1) {
				...
				stareq___ogcC1Md4c289bEhAZWpmZUwsystem((&numFDX60gensym41_), ((NI) 2));
			} LA10: ;
		}
		(*s).fds = (tySequence__5L9b5Ztm9adPEys1vE9cEPQJA*) setLengthSeqV2(&((*s).fds)->Sup, (&NTI__5L9b5Ztm9adPEys1vE9cEPQJA_), ((NI) (numFDX60gensym41_)));
		{
			NI iX60gensym41_;
			NI i;
			iX60gensym41_ = (NI)0;
	...
	LA3_: ;
	{
		...
		numFDX60gensym10_ = (*s).numFD;
		{
			while (1) {
				...
				stareq___ogcC1Md4c289bEhAZWpmZUwsystem((&numFDX60gensym10_), ((NI) 2));
			} LA10: ;
		}
		(*s).fds = (tySequence__5L9b5Ztm9adPEys1vE9cEPQJA*) setLengthSeqV2(&((*s).fds)->Sup, (&NTI__5L9b5Ztm9adPEys1vE9cEPQJA_), ((NI) (numFDX60gensym10_)));
		{
			NI iX60gensym10_;
			NI i;
			iX60gensym10_ = (NI)0;
...
appendString(T18_, T20_);
	...
	genericSeqAssign((&(*skeyX60gensym16_).data.readList), data.readList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	genericSeqAssign((&(*skeyX60gensym16_).data.writeList), data.writeList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	{
		struct epoll_event epv;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI numFDX60gensym95_;
		if (!((*s).numFD <= fdi)) goto LA7_;
		numFDX60gensym95_ = (*s).numFD;
		{
			while (1) {
				if (!(numFDX60gensym95_ <= fdi)) goto LA10;
				stareq___ogcC1Md4c289bEhAZWpmZUwsystem((&numFDX60gensym95_), ((NI) 2));
			} LA10: ;
		}
		(*s).fds = (tySequence__5L9b5Ztm9adPEys1vE9cEPQJA*) setLengthSeqV2(&((*s).fds)->Sup, (&NTI__5L9b5Ztm9adPEys1vE9cEPQJA_), ((NI) (numFDX60gensym95_)));
		{
			NI iX60gensym95_;
			NI i;
			iX60gensym95_ = (NI)0;
			...
			{
				while (1) {
					if (!(i < numFDX60gensym95_)) goto LA13;
					iX60gensym95_ = i;
					(*s).fds->data[iX60gensym95_].ident = ((NI) -1);
					i += ((NI) 1);
				} LA13: ;
			}
		}
		(*s).numFD = numFDX60gensym95_;
	}
	LA7_: ;
	{
		NIM_BOOL T16_;
...
N_LIB_PRIVATE N_NIMCALL(void, unregister__XvANr0Db4lHwmahGhLXGPQ)(tyObject_SelectorImpl__jkoZicTBtYdKkYck5SFJEQ* s, int fd) {
	NI fdi;
	tyObject_SelectorKey__561GPxg10TdJiEAAWoraPw* pkey;
	tyObject_AsyncData__hOYUN4IOpj9adMwn6W7S2VA emptyX60gensym24_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	fdi = ((NI) (fd));
	{
	...
	LA3_: ;
	{
		NI numFDX60gensym17_;
		if (!((*s).numFD <= fdi)) goto LA7_;
		numFDX60gensym17_ = (*s).numFD;
		{
			while (1) {
				if (!(numFDX60gensym17_ <= fdi)) goto LA10;
				stareq___ogcC1Md4c289bEhAZWpmZUwsystem((&numFDX60gensym17_), ((NI) 2));
			} LA10: ;
		}
		(*s).fds = (tySequence__5L9b5Ztm9adPEys1vE9cEPQJA*) setLengthSeqV2(&((*s).fds)->Sup, (&NTI__5L9b5Ztm9adPEys1vE9cEPQJA_), ((NI) (numFDX60gensym17_)));
		{
			NI iX60gensym17_;
			NI i;
			iX60gensym17_ = (NI)0;
			...
			{
				while (1) {
					if (!(i < numFDX60gensym17_)) goto LA13;
					iX60gensym17_ = i;
					(*s).fds->data[iX60gensym17_].ident = ((NI) -1);
					i += ((NI) 1);
				} LA13: ;
			}
		}
		(*s).numFD = numFDX60gensym17_;
	}
	LA7_: ;
	pkey = (&(*s).fds->data[fdi]);
	{
...
appendString(T18_, T20_);
	...
	LA23_: ;
	nimZeroMem((void*)(&emptyX60gensym24_), sizeof(tyObject_AsyncData__hOYUN4IOpj9adMwn6W7S2VA));
	(*pkey).ident = ((NI) -1);
	(*pkey).events = 0;
	genericSeqAssign((&(*pkey).data.readList), emptyX60gensym24_.readList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	genericSeqAssign((&(*pkey).data.writeList), emptyX60gensym24_.writeList, (&NTI__mqHCvcswroDetkzsL3ixtg_));
	}BeforeRet_: ;
}
...
NTI__W6GmT4FRSGpTsHizSNfKpA_.node = &TM__ln5vuDpFyDrAqQbYD2g52Q_0[30];
