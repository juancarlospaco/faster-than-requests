...
typedef N_CLOSURE_PTR(void, TM__Q5wkpxktOdTGvlSRo9bzt9aw_20) (void);
...
N_LIB_PRIVATE N_NIMCALL(void, threadTrouble__amVlU9ajqZ06ujoesRBHcDg_2)(void);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_10, "threads.nim(319, 14) `pthread_attr_init(a) == 0` ", 49);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_11, "threads.nim(320, 14) `pthread_attr_setstacksize(a, ThreadStackS"
"ize) == 0` ", 74);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_12, "API usage error: GC_enable called but GC is already enabled", 59);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_21, "cannot create thread", 20);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_22, "threads.nim(323, 14) `pthread_attr_destroy(a) == 0` ", 52);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_26, "\"", 1);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_27, "\\a", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_28, "\\b", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_29, "\\t", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_30, "\\n", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_31, "\\v", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_32, "\\f", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_33, "\\c", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_34, "\\e", 2);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_38, "\\x", 2);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_39, "0123456789ABCDEF", 16);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_41, "true", 4);
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_42, "false", 5);
...
{	result = (void*)0;
	...
	if (nimAddInt(T1_, (NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_7), &TM__Q5wkpxktOdTGvlSRo9bzt9aw_9)) { raiseOverflow(); goto BeforeRet_;
};
...
{	{
		...
		(*T5_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_12));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		{
			*nimErr_ = NIM_FALSE;
			threadTrouble__amVlU9ajqZ06ujoesRBHcDg_2();
			popCurrentException();
			LA4_:;
		}
	}
...
{nimErr_ = nimErrorFlag();
	...
	(*t).dataFn = tp;
	{
		...
		if (!!((T4_ == ((NI32) 0)))) goto LA5_;
		failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_10));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA5_: ;
	{
		...
		failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_11));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA10_: ;
	{
		...
		T14_ = (int)0;
		T14_ = pthread_create((&(*t).sys), (&a), threadProcWrapper__KwtUyNVh00QDWGRZcngjGA, ((void*) (t)));
		...
		(*T17_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_21));
		(*T17_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T17_, "ResourceExhaustedError", "createThread", "threads.nim", 322);
		goto BeforeRet_;
	}
	LA15_: ;
	{
...
appendString((*s), ((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_38));
		n = ((NU8)(c));
		(*s) = addChar((*s), ((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_39)->data[(NI)((NI64)((NI)(n & ((NI) 240))) >> (NU64)(((NI) 4)))]);
		(*s) = addChar((*s), ((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_39)->data[(NI)(n & ((NI) 15))]);
	}
	break;
	}
}
...
NTI__cT9c9bHlHSpA1QTnKbHjnIkA_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[16];
...
NTI__9cxMi1BPLc3UKt9br86bGfGQ_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[17];
...
NTI__PtYxPmY5X0dorfvxAFbJpQ_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[21];
...
NTI__KFG1Y2EPzgtJWwuYhMD0Fw_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[22];
...
NTI__t7nhKLvXTQS9cS8ByJU9bIag_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[26];
