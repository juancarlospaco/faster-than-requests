...
extern tyProc__MGvm2GDOLe9cOGVrF2xiL8g Dl_24271915_;
extern tyProc__9c803Jlmvw39cDHXPnE9c9acPA Dl_24271928_;
extern NIM_THREADVAR NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__M35TeFGPs7TPKADYDaEq4Q Dl_24271943_;
extern tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_24272059_;
extern tyProc__1jkYBsuhXdCj7QieWqeYyQ Dl_24272101_;
extern tyProc__gjdebP9bh9a6kXA5fmIpsLzQ Dl_24271809_;
...
{nimErr_ = nimErrorFlag();
	...
	db = (tyObject_Sqlite3__xRZkbCqVWSKf8kX4o9cbKXA*)0;
	{
		NI32 T3_;
		T3_ = (NI32)0;
		T3_ = Dl_24271915_(nimToCStringConv(connection), &db);
...
{nimErr_ = nimErrorFlag();
	...
	stmt = (tyObject_TStmt__GsRxsaEvnkRT4evqPcjTkg*)0;
	{
		...
		T3_ = q;
		T4_ = (int)0;
		T4_ = Dl_24271943_(db, nimToCStringConv(T3_), ((int) ((q ? q->Sup.len : 0))), &stmt, NIM_NIL);
